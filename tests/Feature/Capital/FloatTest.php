...
class FloatTest extends TestCase
{
    ...
    public function test_company_float_moves_company_balance_to_branch_principal(): void
    {
        ...
        $this->ledger()->post($admin->company_id, Account::Company, 1000000, 'CAPITAL');
    ...
    public function test_branch_to_branch_float_is_pending_until_approved(): void
    {
        ...
        $this->ledger()->post($admin->company_id, Account::Principal, 300000, 'FLOAT', $admin->branch_id);
    ...
    {
        $admin = $this->signInAdmin();
        $this->ledger()->post($admin->company_id, Account::Principal, 50000, 'FLOAT', $admin->branch_id);
