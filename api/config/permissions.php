...
return [
    ...
    'roles' => [
        ...
        'finance' => ['name' => 'Finance', 'scope' => 'company', 'permissions' => [
            'dashboard.view', 'float.manage', 'bank.manage', 'expenses.approve_branch', 'hq.manage', 'customers.view', 'branches.view_all',
        ...
        'branch_manager' => ['name' => 'Branch Manager', 'scope' => 'branch', 'permissions' => [
            'dashboard.view', 'customers.view', 'customers.manage', 'customers.approve', 'customers.assign_officer',
        ...
        'credit_officer' => ['name' => 'Credit Officer', 'scope' => 'company', 'permissions' => [
            'dashboard.view', 'customers.view', 'branches.view_all', 'loans.view', 'loans.credit_review', 'reports.view', 'messages.use', 'goals.view',
        ]],
