...
class BankAccountTest extends TestCase
{
    ...
    public function test_balance_page_shows_ledger_balances_and_total(): void
    {
        ...
        app(Ledger::class)->openingBalance($admin->company_id, Account::Bank, 16200, 'Deposit', bankAccount: $nmb);
        app(Ledger::class)->openingBalance($admin->company_id, Account::Bank, 2000, 'Deposit', bankAccount: $crdb);
