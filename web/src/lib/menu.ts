...
export const menu: MenuTab[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: "icon-wallet",
        children: [
          { label: "Share Holders", href: "/capital/share-holders", permission: "capital.view" },
          ...
          { label: "Aproved Float", href: "/capital/floats/approved", permission: "float.manage" },
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Aproved Transaction", href: "/bank/transfers/approved", permission: "bank.manage" },
          { label: "Transfor Balance /Branch Acc", href: "/bank/to-branch", permission: "bank.manage" },
          { label: "Transfor Balance /Salary advance & disbursement Acc", href: "/bank/to-hq", permission: "bank.manage" },
          ...
          { label: "Payrol", href: "/bank/payroll", permission: ["bank.manage", "payroll.pay"] },
        ],
      },
      {
        ...
        children: [
          ...
          { label: "Salary Advance Aproved", href: "/salary-advance/approved", permission: "salary_advance.manage" },
      ...
      },
      {
        ...
        icon: "icon-wallet",
        children: [
          { label: "Penarty List", href: "/penalties", permission: "penalties.manage" },
          { label: "Paid Penarty", href: "/penalties/paid", permission: "penalties.manage" },
        ],
      },
      {
        label: "Loan Fee",
      ...
      },
      {
        ...
        children: [
          ...
          { label: "All Aproved Expenses", href: "/hq-expenses/approved", permission: ["hq.manage", "expenses.approve_hq"] },
        ],
      },
      {
        label: "Headquater Transaction",
        icon: "icon-list",
        children: [
          ...
          { label: "Aproved Transaction", href: "/hq/transactions/approved", permission: "hq.manage" },
        ],
      },
      {
        label: "Customer",
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Today Insurelance", href: "/savings/deposits", permission: "savings.manage" },
          { label: "Today withdrawal Insurelance", href: "/savings/withdrawals", permission: "savings.manage" },
          { label: "Insurelance Balance", href: "/savings/balances", permission: "savings.manage" },
        ],
      },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Wright-off Loan", icon: "icon-list", href: "/reports/write-off", permission: "reports.view" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Salary Advanced", icon: "icon-list", href: "/hrm/salary-advances", permission: "hrm.manage" },
      { label: "Staff Loan", icon: "icon-list", href: "/hrm/staff-loans", permission: "hrm.manage" },
