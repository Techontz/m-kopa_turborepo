...
class ExpenseRequestTest extends TestCase
{
    ...
    public function test_branch_request_is_accepted_and_debits_branch_interest_account(): void
    {
        $type = $this->type('branch', 'umeme');
        $this->ledger->openingBalance($this->admin->company_id, Account::Interest, 100000, 'Interest collections', $this->admin->branch_id);
        ...
        // Documents: branch expenses are paid from the branch Interest account.
    ...
    public function test_bank_request_debits_the_bank_account(): void
    {
        ...
        $this->ledger->openingBalance($this->admin->company_id, Account::Bank, 16200, 'Deposit', bankAccount: $bank);
