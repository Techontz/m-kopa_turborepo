...
const sources: DisbursementSources = {
  cash: { value: "cash", label: "PRINCIPAL A/C (CASH) - HQ", balance: 300000, required: 500000 },
  banks: [
...
describe("disbursement source", () => {
  it("resolves the chosen account and checks its balance", () => {
    ...
    expect(selectedSource(sources, { source_account: "cash", source_bank_account_id: "" })?.label).toBe("PRINCIPAL A/C (CASH) - HQ");
